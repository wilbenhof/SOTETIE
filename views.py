...
# päivitetään tietokanta joka maanantai klo 2.30

schedule.every().monday.at("02:30").do(home(all))

# alla olevat testaukseen (joka minuutti / 15 sekunti), minuutti/sekunti määrää voi muuttaa vaihtamalla every(x) numeroa
#schedule.every(1).minutes.do(home(all))
#schedule.every(15).seconds.do(home(all))
